...
- **Deduções à coleta** modeladas linha a linha: dependentes, ascendentes a cargo, deficiência (sujeito passivo e dependentes), encargos com lares (art.º 84º CIRS, por beneficiário — sujeito passivo e ascendentes), PPR, despesas gerais/saúde/educação/habitação, exigência de fatura, trabalho doméstico, donativos, dupla tributação internacional, mais-valias.
...
3. **Simplificações conhecidas** (documentadas em comentários no código, para não ficarem escondidas):
   ...
   - Encargos com lares (art.º 84º CIRS) implementado (v2.53) para o(s) sujeito(s) passivo(s) e ascendentes a cargo. NÃO implementado: dependentes/colaterais até 3º grau em lares/residências autónomas para pessoas com deficiência (art.º 84º n.º 2, 2ª parte) — caso mais raro, sem UI própria ainda. O teto de 403,75€ é por BENEFICIÁRIO, não por quem paga — se outra pessoa fora do agregado também pagar pela mesma pessoa (ex.: outro filho a pagar pelo mesmo idoso), o motor não tem como saber e pode sobrestimar a dedução real.
