...
export const pt = {
  ...
  perfil: {
    ...
    adicionarAnoAnteriorLabel: "Ou adicione um ano anterior, para simular retrospetivamente:",
    adicionarAnoAnteriorPlaceholder: "Ano",
    adicionarAnoAnteriorBotao: "Adicionar",
    anoFiscalSemSuporte: "Ainda não há tabela fiscal para esse ano. Anos disponíveis nesta versão",
